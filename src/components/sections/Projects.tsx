...
const personalProjects: Project[] = [
  {
    ...
    description:
      'Agentic AI system for MSME operations — multi-channel order intake (shop + WhatsApp), inventory reservation, task planning, workforce assignment, and ML-based delay risk prediction. One Express server serves the API and static dashboards.',
    caseStudy: {
      problem:
      ...
      solution:
        'Kalpanik Operations AI runs a multi-agent pipeline: Input Gateway → Order → Inventory → Decision Engine → Workforce → Delay Risk Predictor (ML) → Critic → Executor. Customers only see “order placed” + ID; ops teams use Overview, Agents Log, and WhatsApp Log. State is in-memory (demo-friendly); optional Groq LLM parses WhatsApp text.',
      how: [
        ...
        'Deployed API + UI together on Railway; repo at github.com/jay-07-pixel/KALPANIK_OPERATIONS-AI.',
      ],
      whyBetter: [
    ...
    liveUrl: 'https://kalpanikoperations-ai-production.up.railway.app/',
  ...
  },
  {
    ...
    category: 'Personal Project',
    description:
      'Kalpanik Remind Me — a Flutter app that syncs birthdays and anniversaries from phone contacts, reminds you with a daily full-screen alarm, and helps you send a WhatsApp wish with a greeting card. All data stays on-device; no server or accounts.',
    caseStudy: {
      problem:
        'People forget birthdays and anniversaries even when the dates sit unused in their contact book. Generic calendar apps don’t sync contact events well, and sending a thoughtful WhatsApp wish with a card still takes extra steps.',
      solution:
        'Remind Me reads contacts with birthdays/anniversaries, shows today and upcoming on a home dashboard, fires a full-screen alarm at a chosen time, tracks who you’ve wished this year, and lets you share editable templates plus greeting cards (built-in or gallery) to WhatsApp — fully offline/local.',
      how: [
        ...
        'Stored profile, reminder time, templates, and wish status in shared_preferences (no backend).',
        'Added greeting card assets and share_plus / url_launcher for WhatsApp card + message sharing.',
        'Shipped onboarding, registration, permissions, contact sync, home, contact details, alarm screen, and message templates.',
      ],
      whyBetter: [
        'Better than relying on memory because contact dates become today’s list and upcoming reminders.',
        'Better than a plain notification because the full-screen alarm lists celebrations until you dismiss it.',
        'Better than copy-paste WhatsApp wishes because templates and greeting cards are built into the flow.',
        'Better for privacy than cloud social apps because contacts and wishes never leave the device.',
      ],
    },
    features: [
